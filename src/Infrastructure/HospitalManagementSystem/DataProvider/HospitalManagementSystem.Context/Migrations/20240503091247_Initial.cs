        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Interactions = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    SideEffects = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", maxLength: 36, nullable: false),
                    Version = table.Column<string>(type: "nvarchar", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastUpdatedOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    DeleteOn = table.Column<DateTime>(type: "datetime", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ICDVersion", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiseasesId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastUpdatedOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    DeleteOn = table.Column<DateTime>(type: "datetime", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ICDCode_Diseases_DiseasesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalExamEpisode", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalExamEpisode_MedicalExam_MedicalExamId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", maxLength: 36, nullable: false),
                    ICDCodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ICDVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastUpdatedOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    DeleteOn = table.Column<DateTime>(type: "datetime", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ICDCodeVersion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ICDCodeVersion_ICDCode_ICDCodeId",
                        column: x => x.ICDCodeId,
                        principalTable: "ICDCode",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ICDCodeVersion_ICDVersion_ICDVersionId",
                        column: x => x.ICDVersionId,
                        principalTable: "ICDVersion",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Symptom = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Diagnosis_MedicalExamEpisode_MedicalExamEpisodeId",
                        column: x => x.MedicalExamEpisodeId,
                        principalTable: "MedicalExamEpisode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReExamAppointment_MedicalExamEpisode_MedicalExamEpisodeId",
                        column: x => x.MedicalExamEpisodeId,
                        principalTable: "MedicalExamEpisode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomAllocation_MedicalExamEpisode_MedicalExamEposodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrugPrescription_MedicalExamEpisode_MedicalExamEposodeId",
                        column: x => x.MedicalExamEposodeId,
                        principalTable: "MedicalExamEpisode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnalysisTest_MedicalExamEpisode_MedicalExamEpisodeId",
                        column: x => x.MedicalExamEpisodeId,
                        principalTable: "MedicalExamEpisode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", maxLength: 36, nullable: false),
                    Order = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentHistory_MedicalExamEpisode_MedicalExamEpisodeId",
                        column: x => x.MedicalExamEpisodeId,
                        principalTable: "MedicalExamEpisode",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
