...
public class DiagnosisDataProviderTest : DataProviderTestBase
{
    ...
    public async void AddAsync_Success()
    {
        ...
        var diagnosisAdd = Fixture.Build<Domain.Diagnosis>()
                                  .With(i => i.ICDCodeId, icdCodeAdd.Id.ToString())
        ...
        Assert.Equal(diagnosisAdd.ICDCodeId, result?.ICDCodeId.ToString());
    ...
    public async void UpdateAsync_Success()
    {
        ...
        Assert.Equal(diagnosisUpdate.ICDCodeId, result?.ICDCodeId.ToString());
    ...
    public async void UpdateAsync_NotFound_Exception()
    {
        ...
        Assert.Equal(diagnosisAdd.ICDCodeId.ToString(), result?.ICDCodeId.ToString());
    ...
    public async void FindAll_Success()
    {
        ...
        foreach (var result in resultList)
        {
            ...
            Assert.Equal(diagnosis.ICDCodeId.ToString(), result?.ICDCodeId);
    ...
    public async void FindByIdAsync_DisableQuickFind()
    {
        ...
        //Assert
        Assert.NotNull(result);
        Assert.Equal(diagnosisAdd.ICDCodeId.ToString(), result?.ICDCodeId);
