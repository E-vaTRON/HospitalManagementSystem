...
public class UserStoreProvider : IUserStore<CoreUser>
{
    ...
    public DbSet<DataUser> DbSet { get; protected set; }
    #endregion
    ...
    protected virtual async Task<DataUser?> InternalFindByIdAsync(string id, bool asNoTracking = true, CancellationToken cancellationToken = default)
    {
        var mId = ParseId(id!);
    ...
    public async Task<CoreUser?> FindByIdAsync(string userId, CancellationToken cancellationToken)
    {
        ...
        var dbUser = await InternalFindByIdAsync(userId, true, cancellationToken);
    ...
    public async Task<IdentityResult> CreateAsync(CoreUser user, CancellationToken cancellationToken)
    {
        ...
        DataUser dbUser = Mapper.Map<DataUser>(user);
    ...
    public async Task<IdentityResult> UpdateAsync(CoreUser user, CancellationToken cancellationToken)
    {
        ...
        var dbUser = await InternalFindByIdAsync(user.Id, disableQuickFind, cancellationToken);
