...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        //CreateMap<
        //
        //TestDTO, AnalyzationTest>()
        //    .ForMember(d => d.ID, o => o.Ignore());
        //CreateMap<AnalyzationTest, AnalyzationTestDTO>();
        //CreateMap<CreateAnalyzationTestDTO, AnalyzationTest>()
        //    .ForMember(d => d.DeviceID, o => o.Ignore())
        //    .ForMember(d => d.ExamID, o => o.Ignore())
        //    .ForMember(d => d.ID, o => o.Ignore());
        //CreateMap<AnalyzationTest, ReceiveAnalyzationTestDTO>()
